...
const Constant = () => {
  const heroSlider = [
    {
      image: require('../../public/images/hero/0.jpeg'),
      title: 'Explore. Visit. Check-in. Discover Treskscapes.',
      desc: 'Dive into a world of wonder with Treskscapes. Check-in to new horizons, embrace unique adventures, and uncover the magic of every destination waiting for you.',
      spot: 25,
      trackers: '15,689',
      tag: 'Trekscape',
    },
    {
      image: require('../../public/images/hero/1.jpeg'),
      title: 'Travel smarter, Earn as you explore. Make every trip pay off!',
      desc: 'Travel with purpose and earn as you go. Discover a smarter way to explore the world while turning every journey into a rewarding experience that pays back.',
      spot: 25,
      trackers: '15,689',
    },
    {
      image: require('../../public/images/hero/2.jpeg'),
      title: 'Driven by Community, Powered by Adventure.',
      desc: 'Join a vibrant community where explorers come together to shape journeys, validate trekscapes, and unlock exciting rewards. Together, we turn every adventure into a shared success story.',
      spot: 25,
      trackers: '15,689',
      tag: 'Trekscape',
    },
  ...
  const loginItems = [
    ...
    },
    {
      ...
      activeIcon: <Icon name="star-outline" color="#e93c00" size={25} />,
      title: 'Home',
      path: 'Home',
    },
    {
  ...
  const logoutItems = [
    ...
    },
    {
      ...
      activeIcon: <Icon name="home-outline" color="#e93c00" size={25} />,
      title: 'Home',
      path: 'Home',
    },
    {
  ...
  const convertHindiToEnglishNumbers = value => {
    const hindiNumbers = '०१२३४५६७८९';
    return value.replace(/[०-९]/g, d => hindiNumbers.indexOf(d));
  };
